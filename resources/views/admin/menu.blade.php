<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <!-- <li><a href="backend/tag"><i class="fa fa-circle-o"></i> <span>Quản lý tag</span></a></li> -->
        <!-- <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Quản lý tin tức</span>
            <i class="fa fa-angle-left pull-right"></i>
       ...
       <!--  <li>
        ...
        <!-- <li><a href="backend/theloai"><i class="fa fa-circle-o"></i> <span>Quản lý thể loại</span></a></li>
        <li><a href="backend/tacgia"><i class="fa fa-circle-o"></i> <span>Quản lý tác giả</span></a></li>
