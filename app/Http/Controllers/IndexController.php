    ...
    */
    ...
    public function getNewsDetail($id)
    {
        ...
        if (!empty($news_detail)) {
            ...
            return view('templates.news_detail_tpl', compact('news_detail', 'com', 'tintuc_moinhat_detail', 'camnhan_khachhang', 'banner_danhmuc', 'baiviet_khac', 'quangcao_tintuc', 'keyword', 'description', 'title', 'img_share', 'hot_news', 'tinkhac', 'cate_pro','cateNews','tintuc_noibat'));
        } else {
            return redirect()->route('getErrorNotFount');
        }
